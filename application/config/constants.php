...
if(IS_LOCAL){
    defined('BASE_URL')      OR define('BASE_URL', "http://localhost/CodeIgniterDemo/Test/");
    // define('ENVIRONMENT', 'development');

    defined('DB_HOST')      OR define('DB_HOST', "localhost"); 
    defined('DB_USER')      OR define('DB_USER', "root"); 
    defined('DB_PASS')      OR define('DB_PASS', ""); 
    defined('DB_NAME')      OR define('DB_NAME', "vakoqodw_mega"); 
}else{
    ...
    defined('MAIL_ID')      OR define('MAIL_ID', "info@vendordiary.com");
    defined('MAIL_PASSWORD')      OR define('MAIL_PASSWORD', 'Inform$j939');
