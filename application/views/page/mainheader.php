...
<head>
	...
	if (isset($vdata[0])) {
		?>
		<title><?php echo $vdata[0]->business_name ?>
			in <?php echo $this->OH->getcatnamebyid($vdata[0]->category_id); ?>
			-<?php echo $site->website_title; ?></title>
	<meta name="description" content="<?php echo $site->website_description; ?>-<? echo $vdata[0]->description ?>"/>
	<meta name="keyword"
		  content="<?php echo $site->website_keywords; ?>,vendordiary,<? echo $vdata[0]->business_name ?>,<? echo $vdata[0]->description ?>">
		<?php
	...
	<meta property="og:title"
		  content="<? echo $vdata[0]->business_name ?> on <?= $currentURL . "?vid=" . $vdata[0]->id ?>">
	<meta property="og:url" content="<?= $currentURL . "?vid=" . $vdata[0]->id ?>">
	<meta property="og:description"
		  content="<? echo $vdata[0]->business_name ?>-<? echo $vdata[0]->description ?>-<?php echo $site->website_description; ?>">
	<meta property="og:image"
		  content="<?php echo (file_exists('assets/images/' . $vdata[0]->image)) ? base_url() . 'assets/images/' . $vdata[0]->image : base_url() . 'assets/images/wedding-planner/demo.jpg'; ?>">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/v2/css/style.css"/>

	<link rel="icon" type="image/x-icon" sizes="48x48"
		  href="<?php echo base_url(); ?>favicons/<?php echo $site->upload_favicon ?>">
	...
	<meta name="google-signin-client_id"
		  content="172159539927-rsli4anlv0kjd9sfdr358hst7dnk01g7.apps.googleusercontent.com">
...
<noscript>
	<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T82R7T8"
...
<!--Header Start-->
<!-- { START:: Header } -->
<section class="sticky-top w-100 main_header">
	<div class="w-100 details_box bg-dark">
		<div class="container-fluid">
			<div class="py-1 d-flex align-items-center justify-content-between">
				<h6 class="text-light text-capitalize d-flex align-items-center">
					call : <a href="tel:<?php echo $site->contact_no; ?>"><?php echo $site->contact_no ?></a>
					<span class="divider"></span>
					<a href="mailto:<?php echo $site->contact_email ?>"
					   class="text-white"><?php echo $site->contact_email ?> </a>
				</h6>
				...
				<h6 class="text-light text-capitalize d-flex align-items-center">
					...
					if ($this->session->googlelogin == TRUE) {
						echo "<p>";
						echo '<a href="' . base_url() . 'Customerdashboard/" class="text-decoration-none" style="padding-right: 15px;">Dashboard</a>';
	...
	<nav class="navbar navbar-expand-lg bg-light">
		<div class="container-fluid">
			...
			><img src="<?php echo base_url(); ?>assets/v2/images/logo.png" class="logo" alt=""
				/></a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mb-2 mb-lg-0 mt-0">
					<li class="nav-item me-1">
						<a class="nav-link px-3 py-0" aria-current="page" href="<?php echo base_url(); ?>"
						>Home</a
						>
					</li>
					<!--<li class="nav-item me-1">
						<a class="nav-link px-3 py-0" href="#">vendor</a>
					</li>-->
					<li class="nav-item dropdown me-1">
						<a
								class="nav-link dropdown-toggle bg-transparent px-3 py-0"
								href="#"
								role="button"
								id="navbarDropdown"
								...
								aria-haspopup="true"
								aria-expanded="false"
								style="background:<?php echo $site->colour_name; ?>; color:<?php echo $site->font_color; ?>"
						>
							vendor
						</a>
						<ul class="mt-1 dropdown-menu" aria-labelledby="navbarDropdown">
							<div class="d-flex">
								<div>
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/137/0' ?>">
                                ...
                                <defs>
									<style>
										.cls-1 {
											...
											<?php echo $this->OH->getcatnamebyid(137) ?>
										</a>
									</li>
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/154/0' ?>"
										>
                                ...
                                <defs>
									...
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/148/0' ?>">
											<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
												 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
												 xml:space="preserve">
                                <defs>
									<style>
										.cls-1 {
											...
											<?php echo $this->OH->getcatnamebyid(148) ?>
										</a>
									</li>
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/158/0' ?>"
										>
								...
								<div class="flex flex-column">
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/175/0' ?>">
											<svg height="496pt" viewBox="-48 0 496 496" width="496pt"
									...
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/160/0' ?>"
										>
									...
									<li>
										<a class="dropdown-item bg-transparent text-dark "
										   href="<?php echo base_url() . 'GetVendor/vendorbycategory/147/0' ?>">
					...
					<li class="nav-item me-1">
						<a class="nav-link px-3 py-0" href="<?php echo base_url() ?>blog">blog</a>
					</li>
					<li class="nav-item me-1">
						<a class="nav-link px-3 py-0" href="<?php echo base_url() ?>Contactus">contact us</a>
					</li>
				</ul>
				<form class="d-flex align-items-center" role="search">
					<input
							class="form-control me-2 shadow-none px-3 py-0"
							type="search"
							placeholder="Search"
							aria-label="Search"
					/>
					<button
							class="btn btn-primary border-0 shadow-none rounded-pill search_btn p-0 d-flex align-items-center justify-content-center"
							type="submit"
					>
